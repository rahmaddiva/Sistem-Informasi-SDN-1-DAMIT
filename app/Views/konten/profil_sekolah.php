                ...
                <div class="portfolio-details-container">
                    <div class="right">
                        ...
                        <ul class="other-activities">
                            <?php foreach ($profil as $p): ?>
                                <li><strong>Nama Sekolah:</strong> <?= $p['nama_sekolah'] ?></li>
                                <li><strong>Akreditasi:</strong> <?= $p['akreditasi'] ?></li>
                                <li><strong>NPSN:</strong> <?= $p['npsn'] ?></li>
                                <li><strong>NSS:</strong> <?= $p['nss'] ?></li>
                                <li><strong>Bentuk Pendidikan:</strong> <?= $p['bentuk_pendidikan'] ?></li>
                                <li><strong>Status:</strong> <?= $p['status'] ?></li>
                                <li><strong>Kabupaten:</strong> <?= $p['kabupaten'] ?></li>
                                <li><strong>Kelurahan:</strong> <?= $p['kelurahan'] ?></li>
                                <li><strong>Kecamatan:</strong> <?= $p['kecamatan'] ?></li>
                    ...
                    <div class="left">
                        <div class="portfolio-details-carousel">
                            <img src="<?= base_url('landingpage/') ?>assets/img/foto1.png" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
